...
import time
import pandas as pd
from output_file_names_packing_binary_small_scale import output_name_Ex2
global df
...
for p in range(5, 27, 2):
    ...
    b=np.array([4*n]*m)
    for s,kk in [(x,y) for x in [1, 2, 3, 4, 5] for y in [1, 2, 3]]:
