...
import output_file_names_packing_continuous_small_scale
...
title_Mosek = output_file_names_packing_continuous_small_scale.output_name_Mosek
title_Ex3 = output_file_names_packing_continuous_small_scale.output_name_Ex3
title_CP = output_file_names_packing_continuous_small_scale.output_name_CP
x, y_Mosek, y_Ex3, y_CP = read_data(title_Mosek,title_Ex3,title_CP)

fig_name = 'packing_continuous_small'
